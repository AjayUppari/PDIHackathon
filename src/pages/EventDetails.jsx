...
function EventDetails() {
  ...
  const [eventDetailsData, setEventDetailsData] = useState(null); // Initialize as null to distinguish between empty data and uninitialized state
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <RulesSection rules={eventData.rules} />
